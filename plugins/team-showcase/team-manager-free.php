	...
	function team_manager_free_register_shortcode($atts, $content = null){
		...
		$atts = shortcode_atts(
	        ...
	        if(!empty( $team_manager_free_category_select )){
				$tmfree =  array();
				$num 	= count($team_manager_free_category_select);
				for($j=0; $j<$num; $j++){
				...
				$tmf_query = new WP_Query( $args );
					...
					if($team_manager_free_post_themes=="theme1"){
						...
						.team-manager-free-items-'.$post_id.' .team-manager-free-items-profiles-'.$post_id.' a{
							...
							outline: medium none;
							text-decoration: none;
							text-transform: '.$team_manager_name_font_case.';
						}
					...
					echo 'No Shortcode Found!. Please generate a shortcode.';
				}
	...
	if ( ! isset( $_REQUEST['updated'] ) ) {
		...
		<div class="wrap about-wrap">
			<div class="team-versions">
				<h1><?php echo esc_html__('Welcome to Team Showcase V1.9', 'team-showcase');?></h1>
			</div>
