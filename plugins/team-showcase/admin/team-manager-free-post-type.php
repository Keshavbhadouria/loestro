	...
	*/
	...
	function team_manager_free_custom_inner_custom_boxes( $post ) {
		...
		<div id="details_profiles_area">
			<div class="details_profiles_cols">
				...
				<input type="text" name="post_title_designation" placeholder="Designation" id="post_title_designation" value="<?php echo get_post_meta($post->ID, 'client_designation', true); ?>" />

				<!-- Address  -->
				<p><label for="client_address_input"><strong><?php _e('Address', 'team-manager-free');?></strong></label></p>
				<input type="text" name="client_address_input" placeholder="Winston Salem, NC" id="client_address_input" value="<?php echo get_post_meta($post->ID, 'company_address', true); ?>" />

				<!-- Contact Number -->
				<p><label for="contact_number_input"><strong><?php _e('Contact Number', 'team-manager-free');?></strong></label></p>
				<input type="text" name="contact_number_input" placeholder="xxx-xxx-xxxx" id="contact_number_input" value="<?php echo get_post_meta($post->ID, 'contact_number', true); ?>" />
			</div>
			<div class="details_profiles_cols">
				<!-- Contact Email -->
				<p><label for="contact_email_input"><strong><?php _e('Email', 'team-manager-free');?></strong></label></p>
				<input type="text" name="contact_email_input" placeholder="email@exapmle.com" id="contact_email_input" value="<?php echo get_post_meta($post->ID, 'contact_email', true); ?>" />

				<!-- Description -->
				<p><label for="short_description_input"><strong><?php _e('Short Description (Max 140 characters)', 'team-manager-free');?></strong></label></p>
				<textarea name="short_description_input" id="short_description_input" cols="30" rows="4" maxlength="140"><?php echo get_post_meta($post->ID, 'client_shortdescription', true); ?></textarea>
			</div>
		</div>
		<?php
	}
		...
		<div id="details_profiles_area">
			<div class="team-backend-socialprofiles">
				...
				<div class="single-team-social-icons">
					...
					<input type="text" name="facebook_social_input" placeholder="https://example.com/username" id="facebook_social_input" value="<?php echo get_post_meta($post->ID, 'social_facebook', true); ?>" />
				</div>

				<div class="single-team-social-icons">
				<!-- Twitter -->
				<p><label for="twitter_social_input"><strong><?php _e('Twitter', 'team-manager-free');?></strong></label></p>
				<input type="text" name="twitter_social_input" placeholder="https://example.com/username" id="twitter_social_input" value="<?php echo get_post_meta($post->ID, 'social_twitter', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Google plus -->
				<p><label for="googleplus_social_input"><strong><?php _e('Google Plus', 'team-manager-free');?></strong></label></p>
				<input type="text" name="googleplus_social_input" placeholder="https://example.com/username" id="googleplus_social_input" value="<?php echo get_post_meta($post->ID, 'social_googleplus', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Instagram -->
				<p><label for="instagram_social_input"><strong><?php _e('Instagram', 'team-manager-free');?></strong></label></p>
				<input type="text" name="instagram_social_input" placeholder="https://example.com/username" id="instagram_social_input" value="<?php echo get_post_meta($post->ID, 'social_instagram', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Pinterest -->
				<p><label for="pinterest_social_input"><strong><?php _e('Pinterest', 'team-manager-free');?></strong></label></p>
				<input type="text" name="pinterest_social_input" placeholder="https://example.com/username" id="pinterest_social_input" value="<?php echo get_post_meta($post->ID, 'social_pinterest', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- LinkedIn -->
				<p><label for="linkedIn_social_input"><strong><?php _e('LinkedIn', 'team-manager-free');?></strong></label></p>
				<input type="text" name="linkedIn_social_input" placeholder="https://example.com/username" id="linkedIn_social_input" value="<?php echo get_post_meta($post->ID, 'social_linkedin', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Dribbble -->
				<p><label for="dribbble_social_input"><strong><?php _e('Dribbble', 'team-manager-free');?></strong></label></p>
				<input type="text" name="dribbble_social_input" placeholder="https://example.com/username" id="dribbble_social_input" value="<?php echo get_post_meta($post->ID, 'social_dribbble', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Youtube -->
				<p><label for="youtube_social_input"><strong><?php _e('Youtube', 'team-manager-free');?></strong></label></p>
				<input type="text" name="youtube_social_input" placeholder="https://example.com/username" id="youtube_social_input" value="<?php echo get_post_meta($post->ID, 'social_youtube', true); ?>" />
				</div>
				<div class="single-team-social-icons">
				<!-- Youtube -->
				<p><label for="skype_social_input"><strong><?php _e('Skype', 'team-manager-free');?></strong></label></p>
				<input type="text" name="skype_social_input" placeholder="https://example.com/username" id="skype_social_input" value="<?php echo get_post_meta($post->ID, 'social_skype', true); ?>" />
				</div>
			</div>
		</div>
		<?php
	...
	<div class="tupsetings post-grid-metabox">
		...
		<ul class="tab-nav">
			...
			<li nav="4" class="nav4 <?php if($nav_value == 4){echo "active";}?>"><?php _e('Social & Popup box Settings','team-manager-free'); ?></li>
			<li nav="5" class="nav5 <?php if($nav_value == 5){echo "active";}?>"><?php _e('Support & Doc','team-manager-free'); ?></li>
		</ul> <!-- tab-nav end -->
		<?php 
			$getNavValue = "";
					...
					<div class="option-box">
						...
						<table class="form-table">
							<tr valign="top">
								...
								<td style="vertical-align: middle;">
									<select name="team_manager_free_socialicons_hide" id="team_manager_free_socialicons_hide" class="timezone_string">
										<option value="1" <?php if ( isset ( $team_manager_free_socialicons_hide ) ) selected( $team_manager_free_socialicons_hide, '1' ); ?>><?php _e('Show', 'team-manager-free')?></option>
										<option value="0" <?php if ( isset ( $team_manager_free_socialicons_hide ) ) selected( $team_manager_free_socialicons_hide, '0' ); ?>><?php _e('Hide', 'team-manager-free')?></option>
									</select><br>
						...
						<div class="option-box">
							...
							<table class="form-table">
								...
								<tr valign="top">
									...
									<td style="vertical-align: middle;">
										<select name="team_manager_free_popupbox_hide" id="team_manager_free_popupbox_hide" class="timezone_string">
											<option value="1" <?php if ( isset ( $team_manager_free_popupbox_hide ) ) selected( $team_manager_free_popupbox_hide, '1' ); ?>><?php _e('Show', 'team-manager-free')?></option>
											<option value="0" <?php if ( isset ( $team_manager_free_popupbox_hide ) ) selected( $team_manager_free_popupbox_hide, '0' ); ?>><?php _e('Hide', 'team-manager-free')?></option>
										</select><br>
										<span class="team_manager_hint"><?php echo __('Show/Hide Team Member popup details page.', 'team-manager-free'); ?></span>
									</td>
								</tr>
	...
	function save_notice( $post_id ) {
		...
		if( isset( $_POST[ 'team_manager_free_category_select' ] ) ) {
            ...
            update_post_meta( 
                $post_id, 'team_manager_free_category_select', 'unchecked');
        }
