...
if(!class_exists('YrmConfig')) {
	...
	class YrmConfig {
		...
		public static function typePaths() {
		    ...
		    $groupList = array('all' => 'All', 'button' => 'Button','inline' => 'Inline', 'popup' => 'Popups');
		...
		private function init() {
			...
			$this->addDefine('EXPM_VERSION', 2.85);
			$this->addDefine('YRM_VERSION_TEXT', '2.8.5');
			$this->addDefine('EXPM_VERSION_PRO', 1.92);
